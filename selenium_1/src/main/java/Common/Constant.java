...
public class Constant {
    ...
    public static final String RAIWAY_URL= "http://railway2.somee.com/";
    public static final String USERNAME = "phuckhang@gmail.com";
