...
//    private final By ticketDepartFromBookAtTimetable = By.xpath("//div//h1[.='Ticket Booked Successfully!']");
    ...
    public int checkAmountExistTicket(String departFrom, String arriveAt, String seatType, String departDate,
        ...
        return Constant.WEBDRIVER.findElements(By.xpath("//td[.='Huế']/following-sibling::td[.='Quảng Ngãi']/following-sibling::td[.='Soft bed']/following-sibling::td[.='6/22/2021']/following-sibling::td[.='2']")).size();
    }

    public String checkExistTicket() {
        String ticket = Constant.WEBDRIVER.findElement(By.xpath("//td[.='Huế']/following-sibling::td[.='Sài Gòn']")).getText();
        return ticket;
    }
